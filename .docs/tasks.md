...
- [x] 5. Construir o formulario de busca no topo.
...
- [x] 6. Criar os estados de interface: inicial, loading, resultado e sem resultado.
...
- [x] 7. Renderizar a sidebar com os dados principais.
...
- [x] 8. Renderizar a area principal com metricas complementares.
...
- [x] 9. Aplicar o layout visual responsivo definido no PRD.
...
- [x] 10. Garantir resiliencia do servico e da UI em cenarios invalidos.
...
- [x] 11. Validar integracao manual com cidades reais.
...
- [x] 12. Fazer verificacao final de build e aderencia ao PRD.
